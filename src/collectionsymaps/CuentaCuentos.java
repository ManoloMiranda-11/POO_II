...
public static String cuentoZorro(){
        ...
        sb.append("\n Había una vez un zorro que caminaba, sediento, por el bosque. "
                ...
                + "de uvas, las cuales desea al instante al servirle para refrescarse "
                + "y apagar su sed. El zorro se acerca al Árbol e intenta alcanzar las "
                ...
                + "en realidad no quería las uvas, dado que aun no estaban maduras, y que "
...
public static String obtenerCuento() {
    return cuentoZorro();
}

public static String obtenerCuento1() {
    return cuentoLechera();
}
